...
function Contact() {
  ...
  return (
    <section className="contact sction" id="contact">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                santoshnepal608@gmail.com
              </span>
              <a
                href="mailto:santoshnepal608@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">9702662075</span>
              <a
                href="https://api.whatsapp.com/send?phone=9862043001&text=Hello, more information"
                className="contact__button"
              >
                Write me{' '}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>{' '}
